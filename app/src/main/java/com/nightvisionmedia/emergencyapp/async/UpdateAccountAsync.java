...
public class UpdateAccountAsync extends AsyncTask <String, String, String>{
    ...
    public UpdateAccountAsync(Context context, int flag) {
    ...
    protected String doInBackground(String... params) {
        if(byGetOrPost == 0){ //means by Get Method
            ...
            try{
                ...
                String link = Endpoints.URL_UPDATE_ACCOUNT+"=?"+Endpoints.KEY_FIRST_NAME+"="+fname+"&"+Endpoints.KEY_LAST_NAME+"="+lname+"&"+Endpoints.KEY_AGE+"="+age
            ...
            try{
                ...
                String link= Endpoints.URL_UPDATE_ACCOUNT;
    ...
    protected void onPostExecute(String result){
        ...
        if(result.equals("Account was updated successfully")){
