...
public class ShowAllSosListRecyclerViewAdapter extends RecyclerView.Adapter<ShowAllSosListRecyclerViewAdapter.ViewHolder>{
    private Context context;
    private List<MainRecyclerViewRowClass> my_data;


    public ShowAllSosListRecyclerViewAdapter(Context context, List<MainRecyclerViewRowClass> my_data) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.itemID = my_data.get(position).getId();
        ...
        String[] temp = {String.valueOf(holder.itemID)};
        //TODO MAKE FAVORITES SAVED BASED OFF OF THE BUNDLED CATEGORY NAME SENT ACROSS
            ...
            public void onClick(View view) {
                ...
                long countTemp =  AlertsFavorites.count(AlertsFavorites.class, "alert_id = ?",temp);
                    if(holder.count == 0)
                    {
                        ...
                        alertsFavorites.setAlertID(holder.itemID);
                    ...
                    if(countTemp > 0)
                    {
                        ...
                        AlertsFavorites.deleteAll(AlertsFavorites.class, "alert_id = ?", String.valueOf(holder.itemID));
                        holder.ivFavorite.setImageResource(R.mipmap.ic_star_off);
